...
def main(Y):
	...
	with open('../mimicdata/labels_' + str(Y) + '_filtered.csv', 'r') as labelsfile:
...
def concat_data(labelsfile, Y, dataset):
	...
	with open('../mimicdata/notes_' + str(Y) + "_" + dataset + '.csv', 'r') as notesfile:
		with open('../mimicdata/notes_' + str(Y) + "_" + dataset + "_labeled.csv", 'w') as outfile:
